...
import cn.keking.config.FastDFSConfig;
import cn.keking.fdfs.client.FastDFSClient;
import cn.keking.fdfs.client.FastDFSException;
...
public class FileController {
    ...
    public String fileUpload(@RequestParam("file") MultipartFile file,
                             HttpServletRequest request) throws JsonProcessingException, FastDFSException {
    ...
    @RequestMapping(value = "fastdfsUrl", method = RequestMethod.GET)
    public String fastdfsUrl(String fileName) throws JsonProcessingException {
        ...
        return new ObjectMapper().writeValueAsString(new ReturnResponse<String>(0, "SUCCESS", fastdfsUrl));
    }
